...
## Gotchas locales
- Kryptonite ya está migrado a FastAPI; Flask queda obsoleto y no debe usarse para trabajo nuevo.
- La siguiente integración técnica prevista es Revolut X. Los detalles y estado van en `roadmap.md`; en este fichero solo mantener gotchas operativos.
